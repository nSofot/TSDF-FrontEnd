...
export default function SharesTransaction() {
    ...
    const GenerateReport = async () => {
        ...
        setTransactions([]);
        try {
            const response = await axios.get(import.meta.env.VITE_BACKEND_URL + "/api/sharesTransactions/all");
        ...
        <div className="w-full h-full flex flex-col bg-gray-100 rounded-md px-12 py-4">
            <div className='flex justify-between items-center mb-4'>
                <div className='w-40% h-full flex flex-col item-center'>
                    <h1 className='text-xl font-semibold text-gray-800'>📥📗 Shares Transaction Reports</h1>
