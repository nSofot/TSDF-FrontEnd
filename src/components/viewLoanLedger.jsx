...
export default function ViewLoanLedger({ loanId }) {
    const { loanLedger, loading, error } = useLoanLedger(loanId);
            ...
            <div className="overflow-y-auto max-h-[60vh]">     
                ...
                <div className="text-sm text-gray-800">          
                    ...
                    >
                        ...
                        <span className="hidden md:block text-right">{b.interest > "0" ? b.interest : "—"}</span>
